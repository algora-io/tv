defmodule Algora.AdsTest do
  ...
  describe "next_ad_slot/1" do
    test "returns the next 10-minute slot" do
      ...
      assert Ads.next_ad_slot(time) == ~U[2024-08-03 10:10:00.000Z]
      ...
      assert Ads.next_ad_slot(time) == ~U[2024-08-03 11:00:00.000Z]

      # Test case 5: Crossing a day boundary
      time = ~U[2024-08-03 23:55:00.123Z]
      assert Ads.next_ad_slot(time) == ~U[2024-08-04 00:00:00.000Z]
    end
