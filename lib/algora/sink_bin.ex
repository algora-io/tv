defmodule Algora.SinkBin do
  ...
  def_options(
    ...
    header_naming_fun: [
      spec:
        (Track.t(), counter :: non_neg_integer() ->
           String.t()),
      default: &Track.default_header_naming_fun/2,
      description: "A function that generates consequent media header names for a given track"
    ],
    segment_naming_fun: [
      spec: (Track.t() -> String.t()),
      default: &Track.default_segment_naming_fun/1,
